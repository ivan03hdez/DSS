...
class PromotionDatabaseTest extends TestCase{
    ...
    public function testBasicTest()
    {
        ...
        $producto1 = new Product(['name' => 'Producto1Promocion1','promotionPrice' => 5.0,'price' => 45.0,'color'=>'rojo','description'=>'probando model promociones','model' => 'model 1','stock' => 100,'image'=>'holaimagen']);

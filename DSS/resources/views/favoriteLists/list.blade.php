...
<div class="row add">
  ...
  @if($favoriteLists->count()==0) No existen tales listas de favoritos.
  @else
  <div class="table-responsive">
    <table class="table table-hover text">
      ...
      <tbody>
        <form class="d-flex col my-auto" type="get" action="{{ url('/favoriteLists/search') }}">
          <td scope="col">

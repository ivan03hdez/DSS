...
<div class="row add">
  ...
  @if($favoriteLists->count()==0) No se ha creado ninguna lista de favoritos.
  @else
    ...
    <table class="table table-hover text">
      ...
      <tbody>
        <form class="d-flex col my-auto" type="get" action="{{ url('/searchFL') }}">
          <td scope="col">
            <div class="col-2-sm admin-outer-container" > 
                  <input class="form-control form-control-lg me-2" name="searchFL-id" type="text">
            </div>
          </td>
          <td scope="col">
            <div class="col-2-sm admin-outer-container" > 
                  <input class="form-control form-control-lg me-2" name="searchFL-name" type="text">
            </div>
          </td>
          <td scope="col">
            <div class="col-2-sm admin-outer-container" > 
                  <input class="form-control form-control-lg me-2" name="searchFL-description" type="text">
            </div>
          </td>
          <td scope="col">
            <div class="col-2-sm admin-outer-container" > 
        ...
        <tr>
          ...
          <td class="icon-trash"><a href="{{action('UserController@delete',$favoriteList->id)}}">
          ...
          <td><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="25px" height="35px" viewBox="0 0 100 100">
